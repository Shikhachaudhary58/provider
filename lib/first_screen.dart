              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    final result = await Navigator.pushNamed(context, '/second', arguments: subjectProvider.subject.name);
                    // Update subject name if result is not null
                    if (result != null) {
                      subjectProvider.updateSubject(result);
                    }
                  },
                  style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.deepPurple
